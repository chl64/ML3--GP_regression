...
covfunc = @covSEard;
% log_ell_1 = ; log_ell_2 = ; log_sf = ;
% hyp.cov = [log_ell_1; log_ell_2; log_sf]
hyp.cov = 0.1 * randn(3, 1);

% covfunc = {@covSum, {@covSEard, @covSEard}}
% hyp.cov = 0.1 * gpml_randn(0.1, 6, 1);
...
title('Performance of a single covSEard')
